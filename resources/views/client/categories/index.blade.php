   ...
   <div class="categories my-5">
      ...
      <div class="row featurette py-3 categories-box">
          <div class="col-md-8 order-md-2 order-1">
              <div class="row">
              <h1 class="categories-box-title"><a href="{{ url('san-pham/'.$row->slug) }}">{{$row->title}}</a></h1>
              <div class="col-md-12">
          ...
          <div class="col-md-4 order-md-1 order-2">
              ...
              <a href="{{ url('san-pham/'.$row->slug) }}" class="categories-box-img"><img class=" mx-auto"  src=" {{asset('images/')}}/{{$row->photo}}" alt=""></a>
          </div>
        </div>
      @endforeach
   </div>
